...
class TestTcpDevice:
    def test_creates_connection_using_specified_endpoint_details(
    ...
    def test_process_dispatches_single_instruction(
        self, monkeypatch: pytest.MonkeyPatch
    ):
    ...
    def test_process_dispatches_multiple_instruction(
        self, monkeypatch: pytest.MonkeyPatch
    ):
    ...
    def test_process_returns_response_instructions(
        self, monkeypatch: pytest.MonkeyPatch
    ):
    ...
    def test_process_closes_connection_when_complete(
        self, monkeypatch: pytest.MonkeyPatch
    ):
        instruction = Instruction(Command.QUERY_ACTIVE_INPUT)
        fake_socket = self.stub_socket(monkeypatch)
